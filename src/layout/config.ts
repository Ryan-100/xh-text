...
export const items: ISide[] = [
  ...
  },
  {
    ...
    icon: "setting",
    // children: [
    //   { name: "Amount", link: "/setting/amount", icon: "dollar" },
    //   { name: "Parcel Type", link: "/setting/parcel-type", icon: "parcel" },
    //   { name: "Weight", link: "/setting/weight", icon: "weight" },
    //   { name: "City", link: "/setting/cities", icon: "city" },
    //   { name: "Counter", link: "/setting/counters", icon: "counter" },
    //   { name: "Roles", link: "/setting/roles", icon: "roles" },
    //   {
    //     name: "Payment method",
    //     link: "/setting/payment-type",
    //     icon: "payment",
    //   },
    //   {
    //     name: "All version update",
    //     link: "/setting/versions",
    //     icon: "version",
    //   },
    // ],
  },
