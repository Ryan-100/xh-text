...
const CustomerDetail = () => {
  ...
  const goToHistory = () => {
    navigate("/reports/customers/1/history");
  };
      ...
      <div className="bg-white rounded-[10px] shadow flex flex-col items-start p-6 space-y-6">
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center justify-center space-x-[84px]">
            ...
            <div className="flex flex-col">
              <p className="text-gray leading-6">Total Package | Amount</p>
              <p className="text-secondary leading-6">20 Packages | 10,000,000 Ks</p>
            </div>
          </div>
          <div className="flex items-center space-x-6">
            ...
            >
              ...
              <p className="btn-lg">Parcel History</p>
            </div>
          </div>
        </div>
