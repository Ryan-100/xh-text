  ...
  return (
    <div className="flex flex-col space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <div className={isdelivery?inactiveButton:activeButton} onClick={pickUpHandler}>Pickup History</div>
        <div className={isdelivery?activeButton:inactiveButton} onClick={deliveryHandler}>Delivery History</div>
      </div>
